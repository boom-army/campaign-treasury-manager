...
export default async function updateEscrowIx(
  { authority, creator, payer, payoutWalletOwner, treasuryMint }: Accounts,
  { updateCampaignEscrowInput, campaignUuid, program }: Args
